...
3. Confirm installed binary reports `ghostty-wall 1.0.4`.
...
1. Tag exactly `v1.0.4` after all gates pass.
2. Release workflow must publish:
   - `ghostty-wall-v1.0.4-x86_64-unknown-linux-gnu.tar.gz` and matching `.sha256` file;
